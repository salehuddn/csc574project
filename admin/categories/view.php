  ...
  <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-end mb-3">
                <a href="../../admin/categories/create.php?category=true" class="btn btn-primary btn-sm">Add Category</a>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody class="border">
                      <?php
                        require('../../admin/queries/getCategories.php');
                      ...
                      <tr class="border">
                        ...
                        <td class="text-center">
                          <a href="../../admin/categories/edit.php?category=true&category_id=<?php echo $id; ?>" class="text-dark"><ion-icon name="create-outline"></ion-icon></a>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- Add Product Button -->
              <div class="d-flex justify-content-end mb-3">
                <a href="../../admin/categories/create.php?subcategory=true" class="btn btn-primary btn-sm">Add Subcategory</a>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody class="border">
                      <?php
                        require('../../admin/queries/getSubCategories.php');
                      ...
                      <tr class="border">
                        ...
                        <td class="text-center">
                          <a href="../../admin/categories/edit.php?subcategory=true&category_id=<?php echo $id; ?>" class="text-dark"><ion-icon name="create-outline"></ion-icon></a>
    ...
    <script>
      ...
      function deleteCategory(categoryId) {
        $.ajax({
          url: '../../admin/queries/destroyCategory.php',
          method: 'POST',
      ...
      function deleteSubcategory(subcategoryId) {
        $.ajax({
          ...
          success: function(response) {
            ...
            if (data.success) {
              setTimeout(function() {
                window.location.href = '../../admin/categories/view.php';
              }, 2000);
            }
          }
        });
