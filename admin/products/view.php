  ...
  <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-end mb-3">
                <a href="../../admin/products/create.php" class="btn btn-sm btn-primary">Add Product</a>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody class="border">
                      <?php
                        require('../../admin/queries/getProducts.php');
                      ...
                      <tr class="border" style="vertical-align: middle;">
                        ...
                        <td>
                          <div class="d-flex flex-wrap">
                            <?php if (!empty($image)) : ?>
                              <a href="../../admin<?php echo $image; ?>" target="_blank">
                                <img src="../../admin<?php echo $image; ?>" class="rounded float-start me-2" alt="image" width="25" height="25">
                              </a>
                            <?php else : ?>
                        ...
                        <td class="text-center">
                          <a href="../../admin/products/edit.php?product_id=<?php echo $id; ?>" class="text-dark"><ion-icon name="create-outline"></ion-icon></a>
    ...
    <script>
      ...
      function deleteProduct(productId) {
        $.ajax({
          url: '../../admin/queries/destroyProduct.php',
          method: 'POST',
          ...
          success: function(response) {
            ...
            if (data.success) {
              setTimeout(function() {
                window.location.href = '../../admin/products/view.php';
              }, 2000);
            }
          }
        });
